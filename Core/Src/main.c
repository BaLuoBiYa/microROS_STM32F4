...
/* USER CODE BEGIN PV */
// static uint8_t ucHeapCCM[configTOTAL_HEAP_SIZE] __attribute__((section(".ccmram")));
static uint8_t ucHeapCCM[configTOTAL_HEAP_SIZE];

HeapRegion_t xHeapRegions[] =
    {
        {ucHeapCCM, configTOTAL_HEAP_SIZE},
        {NULL, 0}};
/* USER CODE END PV */
...
static void MX_GPIO_Init(void)
{
    ...
    /*Configure GPIO pin Output Level */
    HAL_GPIO_WritePin(LEB_BLUE_GPIO_Port, LEB_BLUE_Pin, GPIO_PIN_RESET);
    ...
    /*Configure GPIO pin : LEB_BLUE_Pin */
    GPIO_InitStruct.Pin   = LEB_BLUE_Pin;
    GPIO_InitStruct.Mode  = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull  = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    HAL_GPIO_Init(LEB_BLUE_GPIO_Port, &GPIO_InitStruct);
